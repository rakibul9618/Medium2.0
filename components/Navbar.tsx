...
const Navbar: NextPage = () => {
  return (
    <nav className="flex justify-center bg-yellow-400 border-b border-b-black">
      <div className="flex-1 flex justify-between items-center max-w-screen-2xl p-4 ">
        <div className="logo w-40 cursor-pointer">
          <Link href="/">
            <svg viewBox="0 0 3940 610" className="w-full">
